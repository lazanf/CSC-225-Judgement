...
public class Attack {
    ...
    public Rectangle getHitBox(Mob mob, int boxNumber) {
        Rectangle r = null;
        if (boxNumber == 1)
            r = new Rectangle((int) mob.getXLoc() + hitBoxX, (int) mob.getYLoc() + hitBoxY, boundSize, boundSize);
        if (boxNumber == 2)
            r = new Rectangle((int) mob.getXLoc() + hitBoxX2, (int) mob.getYLoc() + hitBoxY2, boundSize2, boundSize2);
        if (boxNumber == 3)
            r = new Rectangle((int) mob.getXLoc() + hitBoxX3, (int) mob.getYLoc() + hitBoxY3, boundSize3, boundSize3);
        if (boxNumber == 4)
            r = new Rectangle((int) mob.getXLoc() + hitBoxX4, (int) mob.getYLoc() + hitBoxY4, boundSize4, boundSize4);
        return r;
    }
     ...
     ************************************************************/
    public int getInOutTotal() {
        return totalInOutFrames;
    }

    public int getInOutDelay() {
        return inOutDelay;
    }
    ...
    public boolean hasInOutAnim() {
        return hasInOutAnim;
    }

    public boolean hasAttackAnim() {
        return hasAttackAnim;
    }

...
public class AnimatedSprite extends Sprite {
     ...
     ************************************************************************/
    public AnimatedSprite(JPanel frame, Graphics2D g2d, SpriteSheet sheet, int spriteNumber, String name) {
        super(frame, g2d);
    ...
    public void setTempDelay(int delay) {
        tempDelay = delay;
    }
    ...
    public int getSpriteSize() {
        return super.spriteSize;
    }

    public void setSpriteSize(int spriteSize) {
        super.spriteSize = spriteSize;
    }
    ...
    public void updateFrame() {
        if (animating) {
            ...
            if (tempDelay == 0) {
                ...
                int spriteNumber2 = getSpriteNumber();
                SpriteSheet sheet2 = getSheet();

                if (currentFrame == spriteNumber2 - 1 + totalFrames()) {
                    currFrame = spriteNumber2;
                    animImage.setImage(setSprite(sheet2, currentFrame));
                    tempDelay = delay;
                    return;
                }
                currFrame++;

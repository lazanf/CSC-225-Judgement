...
public class Tile extends AnimatedSprite {
     ...
     ******************************************************************************************/
    public Tile(JPanel frame, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber) {
     ...
     **************************************************************************/
    public Tile(JPanel frame, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber, boolean solid) {
        super(frame, g2d, sheet, spriteNumber, name);
        _solid = solid;
        _slippery = false;
        _breakable = false;
     ...
     ******************************************************************/
    public Tile(JPanel frame, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber, boolean solid, boolean slippery, boolean breakable) {
        super(frame, g2d, sheet, spriteNumber, name);
        _solid = solid;
        _slippery = slippery;
     ...
     * @param g2d   - Reference Constructor 1
     *********************************************************************/
    public Tile(Tile tile, JPanel frame, Graphics2D g2d) {
     ...
     ***************************************************************************/
    public void renderTile(int x, int y, Graphics2D g2d, JPanel frame) {
	...
	public Boolean DistanceFrom(AnimatedSprite playerSprite ,Tile sprite2)
	{
		...
		//System.out.println("Player : " + playerSpriteOneBoundXLocation);
		//System.out.println("Tile : " + spriteTwoBoundXLocation);
